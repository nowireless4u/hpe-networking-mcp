...
@tool(
    name="edgeconnect_get_traffic_behavior_mode",
    description="GET /trafficBehaviorMode\n\ngetTrafficBehaviorMode\n\nGet traffic behavior mode status",
    capability=Capability.READ,
)
async def edgeconnect_get_traffic_behavior_mode(
    ctx: Context,
    nePk: Annotated[
        str | None,
        Field(
