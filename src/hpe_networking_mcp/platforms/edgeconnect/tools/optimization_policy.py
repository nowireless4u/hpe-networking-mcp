...
@tool(
    name="edgeconnect_get_optimization_maps",
    description="GET /optimizationMaps\n\nOptmap479\n\nRetrieve optimization maps configuration",
    capability=Capability.READ,
)
async def edgeconnect_get_optimization_maps(
    ctx: Context,
    nePk: Annotated[
        str,
        Field(
    ...
    cached: Annotated[
        ...
        Field(
            default=None,
            description="Determines data source. When true (default), retrieves from Orchestrator cache. When false, fetches fresh data from the appliance.",
        ),
    ] = None,
) -> Any:
