...
@tool(
    name="edgeconnect_get_snat_maps",
    description="GET /snatMaps\n\ngetSnatMaps\n\nGet Inter-Segment SNAT Configurations",
    capability=Capability.READ,
)
async def edgeconnect_get_snat_maps(
    ctx: Context,
    nePk: Annotated[
        str,
        Field(
    ...
    cached: Annotated[
        ...
        Field(
            default=None,
            description="When true, returns cached data from Orchestrator. When false, fetches fresh data directly from the appliance. Defaults to true if not specified.",
        ),
    ] = None,
) -> Any:
