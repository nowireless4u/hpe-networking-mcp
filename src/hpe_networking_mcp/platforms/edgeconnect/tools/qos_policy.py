...
@tool(
    name="edgeconnect_get_qos_maps",
    description="GET /qosMaps\n\ngetQoSMaps\n\nRetrieve QoS policy settings for an appliance",
    capability=Capability.READ,
)
async def edgeconnect_get_qos_maps(
    ctx: Context,
    nePk: Annotated[
        str,
        Field(
    ...
    cached: Annotated[
        ...
        Field(
            default=None,
            description="Data source selection. When true or omitted, returns cached data from Orchestrator. When false, fetches fresh data directly from the appliance (slower but more current).",
        ),
    ] = None,
) -> Any:
