...
@tool(
    name="edgeconnect_get_system_info_system",
    description="GET /systemInfo/system\n\ngetApplianceSystemDeployInfo\n\nGet Appliance System Deployment Information",
    capability=Capability.READ,
)
async def edgeconnect_get_system_info_system(
    ctx: Context,
    nePk: Annotated[
        str,
        Field(
