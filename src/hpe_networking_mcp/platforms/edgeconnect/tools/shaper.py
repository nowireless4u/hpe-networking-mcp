...
@tool(
    name="edgeconnect_get_shaper",
    description="GET /shaper\n\nACL555\n\nGet shaper settings for an appliance",
    capability=Capability.READ,
)
async def edgeconnect_get_shaper(
    ctx: Context,
    nePk: Annotated[
        str,
        Field(
    ...
    cached: Annotated[
        ...
        Field(
            default=None,
            description="When true (default), retrieves data from Orchestrator cache. When false, fetches real-time data directly from the appliance.",
        ),
    ] = None,
) -> Any:
