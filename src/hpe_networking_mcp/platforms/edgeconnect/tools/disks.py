...
@tool(
    name="edgeconnect_get_config_report_disk",
    description="GET /configReportDisk\n\ngetDiskInformation\n\nGet disk and storage controller information for an appliance.",
    capability=Capability.READ,
)
async def edgeconnect_get_config_report_disk(
    ctx: Context,
    nePk: Annotated[
        str,
        Field(
