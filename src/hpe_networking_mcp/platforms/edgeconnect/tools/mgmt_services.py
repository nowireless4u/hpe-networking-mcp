...
@tool(
    name="edgeconnect_get_mgmt_services",
    description="GET /mgmtServices\n\ngetManagementServicesConfig\n\nGet Management Services Configuration",
    capability=Capability.READ,
)
async def edgeconnect_get_mgmt_services(
    ctx: Context,
    nePk: Annotated[
        str,
        Field(
    ...
    cached: Annotated[
        ...
        Field(
            default=None,
            description="Data retrieval mode. When 'true' or omitted, returns cached data from Orchestrator. When 'false', fetches live data directly from the appliance and updates the cache.",
        ),
    ] = None,
) -> Any:
