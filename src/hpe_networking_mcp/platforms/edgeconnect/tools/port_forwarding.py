...
@tool(
    name="edgeconnect_get_port_forwarding",
    description="GET /portForwarding\n\nportForwardingGet496\n\nRetrieve port forwarding rules",
    capability=Capability.READ,
)
async def edgeconnect_get_port_forwarding(
    ctx: Context,
    nePk: Annotated[
        str,
        Field(
    ...
    cached: Annotated[
        ...
        Field(
            default=None,
            description="Data source selector. When true, returns cached data from Orchestrator. When false or omitted, fetches fresh data directly from the appliance.",
        ),
    ] = None,
) -> Any:
