...
@tool(
    name="edgeconnect_get_bridge_groups",
    description="GET /bridgeGroups\n\ngetBridgeGroups\n\nGet bridge groups configuration",
    capability=Capability.READ,
)
async def edgeconnect_get_bridge_groups(
    ctx: Context,
    nePk: Annotated[
        str,
        Field(
    ...
    cached: Annotated[
        ...
        Field(
            default=None,
            description="Controls data source: true or omitted returns cached data from Orchestrator database; false queries the appliance directly and updates the cache.",
        ),
    ] = None,
) -> Any:
