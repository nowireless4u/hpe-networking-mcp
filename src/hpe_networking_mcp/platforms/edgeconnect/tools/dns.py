...
@tool(
    name="edgeconnect_get_resolver",
    description="GET /resolver\n\ndns542\n\nGet DNS resolver configuration for an appliance",
    capability=Capability.READ,
)
async def edgeconnect_get_resolver(
    ctx: Context,
    nePk: Annotated[
        str,
        Field(
    ...
    cached: Annotated[
        ...
        Field(
            default=None,
            description="Data retrieval source. When 'true' (default), returns cached data from Orchestrator. When 'false', fetches live data directly from the appliance.",
        ),
    ] = None,
) -> Any:
