...
Service: ``compute-ops-mgmt``   Tag: ``appliance_firmware_bundles_v1``   Operations: 2
"""
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1_appliance_firmware_bundles",
    description="GET /compute-ops-mgmt/v1/appliance-firmware-bundles\n\nget_v1_appliance_firmware_bundles\n\nList all appliance firmware bundles",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1_appliance_firmware_bundles(
    ctx: Context,
    offset: Annotated[
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1_appliance_firmware_bundles_id",
    description="GET /compute-ops-mgmt/v1/appliance-firmware-bundles/{id}\n\nget_v1_appliance_firmware_bundle_by_id\n\nGet an appliance firmware bundle by ID",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1_appliance_firmware_bundles_id(
    ctx: Context,
    ...
    path = f"/compute-ops-mgmt/v1/appliance-firmware-bundles/{path_seg(id)}"
    header_params: dict[str, str] = {}
    if Tenant_Acid is not None:
        header_params["Tenant-Acid"] = str(Tenant_Acid)
    return await greenlake_request(
