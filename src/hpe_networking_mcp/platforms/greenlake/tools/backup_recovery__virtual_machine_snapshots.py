...
Service: ``backup-recovery``   Tag: ``virtual_machine_snapshots``   Operations: 4
"""
...
@tool(
    name="greenlake_delete_backup_recovery_v1beta1_virtual_machines_id_snapshots_snapshot_id",
    description="DELETE /backup-recovery/v1beta1/virtual-machines/{id}/snapshots/{snapshot-id}\n\nDeleteVirtualMachineSnapshot\n\nDelete a virtual machine snapshot.",
    capability=Capability.WRITE_DELETE,
)
async def greenlake_delete_backup_recovery_v1beta1_virtual_machines_id_snapshots_snapshot_id(
    ctx: Context,
    ...
    path = f"/backup-recovery/v1beta1/virtual-machines/{path_seg(id)}/snapshots/{path_seg(snapshot_id)}"
...
@tool(
    name="greenlake_get_backup_recovery_v1beta1_virtual_machines_id_snapshots",
    description="GET /backup-recovery/v1beta1/virtual-machines/{id}/snapshots\n\nVirtualMachineSnapshotList\n\nGet information about all virtual machine snapshots.",
    capability=Capability.READ,
)
async def greenlake_get_backup_recovery_v1beta1_virtual_machines_id_snapshots(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    offset: Annotated[
        int | None,
    ...
    path = f"/backup-recovery/v1beta1/virtual-machines/{path_seg(id)}/snapshots"
...
@tool(
    name="greenlake_get_backup_recovery_v1beta1_virtual_machines_id_snapshots_snapshot_id",
    description="GET /backup-recovery/v1beta1/virtual-machines/{id}/snapshots/{snapshot-id}\n\nVirtualMachineSnapshot\n\nGet details of a virtual machine snapshot.",
    capability=Capability.READ,
)
async def greenlake_get_backup_recovery_v1beta1_virtual_machines_id_snapshots_snapshot_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    snapshot_id: Annotated[str, Field(description="path parameter 'snapshot-id'")],
) -> Any:
...
@tool(
    name="greenlake_patch_backup_recovery_v1beta1_virtual_machines_id_snapshots_snapshot_id",
    description="PATCH /backup-recovery/v1beta1/virtual-machines/{id}/snapshots/{snapshot-id}\n\nVirtualMachineSnapshotUpdate\n\nUpdate a virtual machine snapshot.",
    capability=Capability.WRITE,
)
async def greenlake_patch_backup_recovery_v1beta1_virtual_machines_id_snapshots_snapshot_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    snapshot_id: Annotated[str, Field(description="path parameter 'snapshot-id'")],
