...
Service: ``compute-ops-mgmt``   Tag: ``secure_gateway_appliances_v1beta2``   Operations: 4
"""
...
@tool(
    name="greenlake_delete_compute_ops_mgmt_v1beta2_appliances_device_id",
    description="DELETE /compute-ops-mgmt/v1beta2/appliances/{device_id}\n\ndelete_v1beta2_appliances_by_id\n\nDelete a secure gateway appliance by id",
    capability=Capability.WRITE_DELETE,
)
async def greenlake_delete_compute_ops_mgmt_v1beta2_appliances_device_id(
    ctx: Context,
    device_id: Annotated[str, Field(description="Unique identifier of the appliance to be deleted")],
    ...
    path = f"/compute-ops-mgmt/v1beta2/appliances/{path_seg(device_id)}"
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta2_appliances",
    description="GET /compute-ops-mgmt/v1beta2/appliances\n\nget_v1beta2_appliances\n\nList all secure gateway appliances",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta2_appliances(
    ctx: Context,
    ...
    return await greenlake_request(
        ctx,
        "GET",
        "/compute-ops-mgmt/v1beta2/appliances",
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta2_appliances_device_id",
    description="GET /compute-ops-mgmt/v1beta2/appliances/{device_id}\n\nget_v1beta2_appliances_by_id\n\nGet a secure gateway appliance by id",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta2_appliances_device_id(
    ctx: Context,
    device_id: Annotated[
        str, Field(description="Unique identifier of the appliance for which information is retrieved")
    ],
    Tenant_Acid: Annotated[
        str | None,
        Field(
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta2_appliances_device_id_certificate",
    description="GET /compute-ops-mgmt/v1beta2/appliances/{device_id}/certificate\n\nget_v1beta2_appliances_certificate_by_id\n\nGet secure gateway appliance certificate by id",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta2_appliances_device_id_certificate(
    ctx: Context,
    device_id: Annotated[
        str, Field(description="Unique identifier of the appliance for which information is retrieved")
    ],
    ...
    path = f"/compute-ops-mgmt/v1beta2/appliances/{path_seg(device_id)}/certificate"
    header_params: dict[str, str] = {}
    if Tenant_Acid is not None:
        header_params["Tenant-Acid"] = str(Tenant_Acid)
    return await greenlake_request(
