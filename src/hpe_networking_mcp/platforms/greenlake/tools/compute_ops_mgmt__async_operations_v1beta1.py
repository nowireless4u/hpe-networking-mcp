...
Service: ``compute-ops-mgmt``   Tag: ``async_operations_v1beta1``   Operations: 2
"""
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta1_async_operations",
    description="GET /compute-ops-mgmt/v1beta1/async-operations\n\nget_v1beta1_async_operations\n\nList all async operations",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta1_async_operations(
    ctx: Context,
    ...
    return await greenlake_request(
        ctx,
        "GET",
        "/compute-ops-mgmt/v1beta1/async-operations",
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta1_async_operations_id",
    description="GET /compute-ops-mgmt/v1beta1/async-operations/{id}\n\nget_v1beta1_async_operations_by_id\n\nRetrieve an async operation by ID",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta1_async_operations_id(
    ctx: Context,
    ...
    path = f"/compute-ops-mgmt/v1beta1/async-operations/{path_seg(id)}"
    header_params: dict[str, str] = {}
    if Tenant_Acid is not None:
        header_params["Tenant-Acid"] = str(Tenant_Acid)
    return await greenlake_request(
