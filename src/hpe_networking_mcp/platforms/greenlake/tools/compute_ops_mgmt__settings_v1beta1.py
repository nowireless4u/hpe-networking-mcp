...
Service: ``compute-ops-mgmt``   Tag: ``settings_v1beta1``   Operations: 5
"""
...
@tool(
    name="greenlake_delete_compute_ops_mgmt_v1beta1_settings_id",
    description="DELETE /compute-ops-mgmt/v1beta1/settings/{id}\n\ndelete_v1beta1_settings_by_id\n\nDelete a device setting",
    capability=Capability.WRITE_DELETE,
)
async def greenlake_delete_compute_ops_mgmt_v1beta1_settings_id(
    ctx: Context,
    ...
    path = f"/compute-ops-mgmt/v1beta1/settings/{path_seg(id)}"
...
async def greenlake_get_compute_ops_mgmt_v1beta1_settings(
    ...
    return await greenlake_request(
        ctx,
        "GET",
        "/compute-ops-mgmt/v1beta1/settings",
        query_params=query_params or None,
        header_params=header_params or None,
    )
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta1_settings_id",
    description="GET /compute-ops-mgmt/v1beta1/settings/{id}\n\nget_v1beta1_settings_by_id\n\nGet a device setting by ID",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta1_settings_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    Tenant_Acid: Annotated[
        str | None,
...
@tool(
    name="greenlake_patch_compute_ops_mgmt_v1beta1_settings_id",
    description="PATCH /compute-ops-mgmt/v1beta1/settings/{id}\n\npatch_v1beta1_settings_by_id\n\nPatch a device setting",
    capability=Capability.WRITE,
)
async def greenlake_patch_compute_ops_mgmt_v1beta1_settings_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
...
@tool(
    name="greenlake_post_compute_ops_mgmt_v1beta1_settings",
    description="POST /compute-ops-mgmt/v1beta1/settings\n\ncreate_settings\n\nCreate a device setting",
    capability=Capability.WRITE,
)
async def greenlake_post_compute_ops_mgmt_v1beta1_settings(
    ctx: Context,
    Content_Type: Annotated[
        str,
        Field(
