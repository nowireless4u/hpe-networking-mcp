...
Service: ``compute-ops-mgmt``   Tag: ``oneview_server_templates_v1beta1``   Operations: 2
"""
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta1_oneview_server_templates",
    description="GET /compute-ops-mgmt/v1beta1/oneview-server-templates\n\nget_v1beta1_oneview_server_templates\n\nList all OneView server templates",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta1_oneview_server_templates(
    ctx: Context,
    ...
    return await greenlake_request(
        ctx,
        "GET",
        "/compute-ops-mgmt/v1beta1/oneview-server-templates",
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta1_oneview_server_templates_id",
    description="GET /compute-ops-mgmt/v1beta1/oneview-server-templates/{id}\n\nget_v1beta1_oneview_server_templates_by_templateid\n\nGet a OneView server template by template id",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta1_oneview_server_templates_id(
    ctx: Context,
    ...
    path = f"/compute-ops-mgmt/v1beta1/oneview-server-templates/{path_seg(id)}"
    header_params: dict[str, str] = {}
    if Tenant_Acid is not None:
        header_params["Tenant-Acid"] = str(Tenant_Acid)
    return await greenlake_request(
