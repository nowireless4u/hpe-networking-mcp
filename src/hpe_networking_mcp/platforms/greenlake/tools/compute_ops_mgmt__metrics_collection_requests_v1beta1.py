...
Service: ``compute-ops-mgmt``   Tag: ``metrics_collection_requests_v1beta1``   Operations: 1
"""
...
@tool(
    name="greenlake_post_compute_ops_mgmt_v1beta1_metrics_collection_requests",
    description="POST /compute-ops-mgmt/v1beta1/metrics-collection-requests\n\ncreate_v1beta1_metrics_collection_request\n\nCreate a metrics collection request",
    capability=Capability.WRITE,
)
async def greenlake_post_compute_ops_mgmt_v1beta1_metrics_collection_requests(
    ctx: Context,
    ...
    return await greenlake_request(
        ctx,
        "POST",
        "/compute-ops-mgmt/v1beta1/metrics-collection-requests",
