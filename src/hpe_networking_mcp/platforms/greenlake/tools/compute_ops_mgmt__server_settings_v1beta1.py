...
Service: ``compute-ops-mgmt``   Tag: ``server_settings_v1beta1``   Operations: 5
"""
...
@tool(
    name="greenlake_delete_compute_ops_v1beta1_server_settings_id",
    description="DELETE /compute-ops/v1beta1/server-settings/{id}\n\ndelete_v1beta1_server_settings_by_id\n\nDelete a server-settings item",
    capability=Capability.WRITE_DELETE,
)
async def greenlake_delete_compute_ops_v1beta1_server_settings_id(
    ctx: Context,
    ...
    path = f"/compute-ops/v1beta1/server-settings/{path_seg(id)}"
...
@tool(
    name="greenlake_get_compute_ops_v1beta1_server_settings_id",
    description="GET /compute-ops/v1beta1/server-settings/{id}\n\nget_v1beta1_server_settings_by_id\n\nGet a server-settings item by ID",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_v1beta1_server_settings_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    Tenant_Acid: Annotated[
        str | None,
...
@tool(
    name="greenlake_patch_compute_ops_v1beta1_server_settings_id",
    description="PATCH /compute-ops/v1beta1/server-settings/{id}\n\npatch_v1beta1_server_settings_by_id\n\nPatch a server-settings item",
    capability=Capability.WRITE,
)
async def greenlake_patch_compute_ops_v1beta1_server_settings_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
...
@tool(
    name="greenlake_post_compute_ops_v1beta1_server_settings",
    description="POST /compute-ops/v1beta1/server-settings\n\ncreate_server_settings\n\nCreate server settings",
    capability=Capability.WRITE,
)
async def greenlake_post_compute_ops_v1beta1_server_settings(
    ctx: Context,
    Content_Type: Annotated[
        str,
        Field(
