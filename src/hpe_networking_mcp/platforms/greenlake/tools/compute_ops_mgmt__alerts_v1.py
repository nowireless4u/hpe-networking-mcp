...
Service: ``compute-ops-mgmt``   Tag: ``alerts_v1``   Operations: 1
"""
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1_alerts",
    description="GET /compute-ops-mgmt/v1/alerts\n\nget_v1_alerts\n\nList all alerts",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1_alerts(
    ctx: Context,
    offset: Annotated[
