...
Service: ``backup-recovery``   Tag: ``virtual_machine_backups``   Operations: 4
"""
...
@tool(
    name="greenlake_delete_backup_recovery_v1beta1_virtual_machines_id_backups_backup_id",
    description="DELETE /backup-recovery/v1beta1/virtual-machines/{id}/backups/{backup-id}\n\nDeleteVirtualMachineBackup\n\nDelete a virtual machine backup.",
    capability=Capability.WRITE_DELETE,
)
async def greenlake_delete_backup_recovery_v1beta1_virtual_machines_id_backups_backup_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    backup_id: Annotated[str, Field(description="path parameter 'backup-id'")],
) -> Any:
    path = f"/backup-recovery/v1beta1/virtual-machines/{path_seg(id)}/backups/{path_seg(backup_id)}"
...
@tool(
    name="greenlake_get_backup_recovery_v1beta1_virtual_machines_id_backups",
    description="GET /backup-recovery/v1beta1/virtual-machines/{id}/backups\n\nVirtualMachineBackupList\n\nGet information about all virtual machine backups.",
    capability=Capability.READ,
)
async def greenlake_get_backup_recovery_v1beta1_virtual_machines_id_backups(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    offset: Annotated[
        int | None,
    ...
    path = f"/backup-recovery/v1beta1/virtual-machines/{path_seg(id)}/backups"
...
@tool(
    name="greenlake_get_backup_recovery_v1beta1_virtual_machines_id_backups_backup_id",
    description="GET /backup-recovery/v1beta1/virtual-machines/{id}/backups/{backup-id}\n\nVirtualMachineBackup\n\nGet details of a virtual machine backup.",
    capability=Capability.READ,
)
async def greenlake_get_backup_recovery_v1beta1_virtual_machines_id_backups_backup_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    backup_id: Annotated[str, Field(description="path parameter 'backup-id'")],
) -> Any:
...
@tool(
    name="greenlake_patch_backup_recovery_v1beta1_virtual_machines_id_backups_backup_id",
    description="PATCH /backup-recovery/v1beta1/virtual-machines/{id}/backups/{backup-id}\n\nVirtualMachineBackupUpdate\n\nUpdate a virtual machine backup.",
    capability=Capability.WRITE,
)
async def greenlake_patch_backup_recovery_v1beta1_virtual_machines_id_backups_backup_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    backup_id: Annotated[str, Field(description="path parameter 'backup-id'")],
