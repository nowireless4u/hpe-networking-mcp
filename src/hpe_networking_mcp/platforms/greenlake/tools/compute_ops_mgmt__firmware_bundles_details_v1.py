...
Service: ``compute-ops-mgmt``   Tag: ``firmware_bundles_details_v1``   Operations: 1
"""
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1_firmware_bundles_id_bundle_details",
    description="GET /compute-ops-mgmt/v1/firmware-bundles/{id}/bundle-details\n\nget_v1_firmware_bundle_details_by_id\n\nGet component details by firmware bundle ID",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1_firmware_bundles_id_bundle_details(
    ctx: Context,
    ...
    path = f"/compute-ops-mgmt/v1/firmware-bundles/{path_seg(id)}/bundle-details"
