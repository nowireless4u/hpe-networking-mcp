...
Service: ``virtualization``   Tag: ``hypervisor_networks``   Operations: 2
"""
...
@tool(
    name="greenlake_get_virtualization_v1beta1_hypervisor_managers_hypervisor_id_networks_network_id",
    description="GET /virtualization/v1beta1/hypervisor-managers/{hypervisor-id}/networks/{network-id}\n\nHypervisorNetwork\n\nGet a hypervisor network resource identified by {network-id}",
    capability=Capability.READ,
)
async def greenlake_get_virtualization_v1beta1_hypervisor_managers_hypervisor_id_networks_network_id(
    ctx: Context,
    hypervisor_id: Annotated[str, Field(description="path parameter 'hypervisor-id'")],
    network_id: Annotated[str, Field(description="path parameter 'network-id'")],
) -> Any:
    path = f"/virtualization/v1beta1/hypervisor-managers/{path_seg(hypervisor_id)}/networks/{path_seg(network_id)}"
...
@tool(
    name="greenlake_get_virtualization_v1beta1_hypervisor_managers_uuid_networks",
    description="GET /virtualization/v1beta1/hypervisor-managers/{uuid}/networks\n\nHypervisorNetworkList\n\nGet all network resources in a registered hypervisor manager.",
    capability=Capability.READ,
)
async def greenlake_get_virtualization_v1beta1_hypervisor_managers_uuid_networks(
    ctx: Context,
    ...
    filter: Annotated[
        ...
        Field(
            default=None,
            description='The filter query parameter is used to filter the set of resources returned in the response. The returned set of resources must match the criteria in the filter query parameter.  A comparison compares a property name to a literal. The following comparisons are supported: * “eq” : Is a property equal to value. Valid for number, boolean and string properties. * “ne” : Is a property not equal to value. Valid for number, boolean and string properties. * “gt” : Is a property greater than a value. Valid for number or string timestamp properties. * “lt” : Is a property less than a value. Valid for number or string timestamp properties * “in” : Is a value in a property (that is an array of strings)  Examples: * GET /virtualization/v1beta1/hypervisor-managers/{uuid}/networks?filter="status eq ERROR"  Filters are supported on the following attributes: * state * status * createdAt * name * services * displayName',
        ),
    ] = None,
    sort: Annotated[
        str | None,
    ...
    path = f"/virtualization/v1beta1/hypervisor-managers/{path_seg(uuid)}/networks"
