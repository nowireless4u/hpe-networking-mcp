...
Service: ``backup-recovery``   Tag: ``datastore_backups``   Operations: 4
"""
...
@tool(
    name="greenlake_delete_backup_recovery_v1beta1_datastores_id_backups_backup_id",
    description="DELETE /backup-recovery/v1beta1/datastores/{id}/backups/{backup-id}\n\nDeleteDatastoreBackup\n\nDelete a datastore backup.",
    capability=Capability.WRITE_DELETE,
)
async def greenlake_delete_backup_recovery_v1beta1_datastores_id_backups_backup_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    backup_id: Annotated[str, Field(description="path parameter 'backup-id'")],
) -> Any:
    path = f"/backup-recovery/v1beta1/datastores/{path_seg(id)}/backups/{path_seg(backup_id)}"
...
@tool(
    name="greenlake_get_backup_recovery_v1beta1_datastores_id_backups",
    description="GET /backup-recovery/v1beta1/datastores/{id}/backups\n\nDatastoreBackupList\n\nGet information about all datastore backups.",
    capability=Capability.READ,
)
async def greenlake_get_backup_recovery_v1beta1_datastores_id_backups(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    offset: Annotated[
        int | None,
    ...
    path = f"/backup-recovery/v1beta1/datastores/{path_seg(id)}/backups"
...
@tool(
    name="greenlake_get_backup_recovery_v1beta1_datastores_id_backups_backup_id",
    description="GET /backup-recovery/v1beta1/datastores/{id}/backups/{backup-id}\n\nDatastoreBackup\n\nGet details of a datastore backup.",
    capability=Capability.READ,
)
async def greenlake_get_backup_recovery_v1beta1_datastores_id_backups_backup_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    backup_id: Annotated[str, Field(description="path parameter 'backup-id'")],
) -> Any:
...
@tool(
    name="greenlake_patch_backup_recovery_v1beta1_datastores_id_backups_backup_id",
    description="PATCH /backup-recovery/v1beta1/datastores/{id}/backups/{backup-id}\n\nDatastoreBackupUpdate\n\nUpdate a datastore backup.",
    capability=Capability.WRITE,
)
async def greenlake_patch_backup_recovery_v1beta1_datastores_id_backups_backup_id(
    ctx: Context,
    id: Annotated[str, Field(description="path parameter 'id'")],
    backup_id: Annotated[str, Field(description="path parameter 'backup-id'")],
