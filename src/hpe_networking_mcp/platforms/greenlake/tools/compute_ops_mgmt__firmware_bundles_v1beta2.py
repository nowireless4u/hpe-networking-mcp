...
Service: ``compute-ops-mgmt``   Tag: ``firmware_bundles_v1beta2``   Operations: 2
"""
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta2_firmware_bundles",
    description="GET /compute-ops-mgmt/v1beta2/firmware-bundles\n\nget_v1beta2_firmware_bundles\n\nList all firmware bundles",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta2_firmware_bundles(
    ctx: Context,
    offset: Annotated[
    ...
    return await greenlake_request(
        ctx,
        "GET",
        "/compute-ops-mgmt/v1beta2/firmware-bundles",
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta2_firmware_bundles_id",
    description="GET /compute-ops-mgmt/v1beta2/firmware-bundles/{id}\n\nget_v1beta2_firmware_bundle_by_id\n\nGet a firmware bundle by ID",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta2_firmware_bundles_id(
    ctx: Context,
    ...
    path = f"/compute-ops-mgmt/v1beta2/firmware-bundles/{path_seg(id)}"
    header_params: dict[str, str] = {}
    if Tenant_Acid is not None:
        header_params["Tenant-Acid"] = str(Tenant_Acid)
    return await greenlake_request(
