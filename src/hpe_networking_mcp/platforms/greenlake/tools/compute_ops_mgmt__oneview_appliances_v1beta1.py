...
Service: ``compute-ops-mgmt``   Tag: ``oneview_appliances_v1beta1``   Operations: 4
"""
...
@tool(
    name="greenlake_delete_compute_ops_mgmt_v1beta1_oneview_appliances_device_id",
    description="DELETE /compute-ops-mgmt/v1beta1/oneview-appliances/{device-id}\n\ndelete_v1beta1_oneview_appliances_by_id\n\nDelete a OneView appliance by id",
    capability=Capability.WRITE_DELETE,
)
async def greenlake_delete_compute_ops_mgmt_v1beta1_oneview_appliances_device_id(
    ctx: Context,
    device_id: Annotated[str, Field(description="Unique identifier of the OneView appliance to be deleted")],
    ...
    path = f"/compute-ops-mgmt/v1beta1/oneview-appliances/{path_seg(device_id)}"
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta1_oneview_appliances",
    description="GET /compute-ops-mgmt/v1beta1/oneview-appliances\n\nget_v1beta1_oneview_appliances\n\nList all OneView appliances",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta1_oneview_appliances(
    ctx: Context,
...
@tool(
    name="greenlake_get_compute_ops_mgmt_v1beta1_oneview_appliances_device_id",
    description="GET /compute-ops-mgmt/v1beta1/oneview-appliances/{device-id}\n\nget_v1beta1_oneview_appliances_by_id\n\nGet a OneView appliance by id",
    capability=Capability.READ,
)
async def greenlake_get_compute_ops_mgmt_v1beta1_oneview_appliances_device_id(
    ctx: Context,
    device_id: Annotated[
        str, Field(description="Unique identifier of the OneView appliance for which information is retrieved")
    ],
    Tenant_Acid: Annotated[
        str | None,
        Field(
...
@tool(
    name="greenlake_post_compute_ops_mgmt_v1beta1_oneview_appliances",
    description="POST /compute-ops-mgmt/v1beta1/oneview-appliances\n\nadd_v1beta1_oneview_appliances\n\nAdd a OneView appliance",
    capability=Capability.WRITE,
)
async def greenlake_post_compute_ops_mgmt_v1beta1_oneview_appliances(
    ctx: Context,
