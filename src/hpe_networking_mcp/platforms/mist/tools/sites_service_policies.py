...
@_mcp_tool(
    name="mist_list_site_service_policies_derived",
    description="GET /api/v1/sites/{site_id}/servicepolicies/derived\n\nlistSiteServicePoliciesDerived\n\nGet the list of derived Service Policies for a Site",
    tags={"mist"},
    annotations=ToolAnnotations(readOnlyHint=True, destructiveHint=False),
)
async def mist_list_site_service_policies_derived(
    ctx: Context,
