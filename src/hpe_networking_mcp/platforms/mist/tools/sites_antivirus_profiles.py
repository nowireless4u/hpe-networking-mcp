...
@_mcp_tool(
    name="mist_list_site_antivirus_profiles_derived",
    description="GET /api/v1/sites/{site_id}/avprofiles/derived\n\nlistSiteAntivirusProfilesDerived\n\nGet the list of derived Antivirus Profiles for a site",
    tags={"mist"},
    annotations=ToolAnnotations(readOnlyHint=True, destructiveHint=False),
)
async def mist_list_site_antivirus_profiles_derived(
    ctx: Context,
