...
@_mcp_tool(
    name="mist_count_org_wan_client_events",
    description="GET /api/v1/orgs/{org_id}/wan_client/events/count\n\ncountOrgWanClientEvents\n\nCount by Distinct Attributes of Org WAN Client-Events",
    capability=Capability.READ,
)
async def mist_count_org_wan_client_events(
    ctx: Context,
...
@_mcp_tool(
    name="mist_count_org_wan_clients",
    description="GET /api/v1/orgs/{org_id}/wan_clients/count\n\ncountOrgWanClients\n\nCount by Distinct Attributes of Org WAN Clients",
    capability=Capability.READ,
)
async def mist_count_org_wan_clients(
    ctx: Context,
    org_id: Annotated[str, Field(description="path parameter 'org_id'")],
    distinct: Annotated[
        Any | None,
        Field(description="Field used to group this count response. enum: `hostname`, `ip`, `mac`, `mfg`, `network`"),
    ] = None,
    start: Annotated[
        str | None,
        Field(
...
@_mcp_tool(
    name="mist_search_org_wan_client_events",
    description="GET /api/v1/orgs/{org_id}/wan_clients/events/search\n\nsearchOrgWanClientEvents\n\nSearch Org WAN Client Events",
    capability=Capability.READ,
)
async def mist_search_org_wan_client_events(
    ctx: Context,
    org_id: Annotated[str, Field(description="path parameter 'org_id'")],
    type: Annotated[
        str | None, Field(description="See [List Device Events Definitions](/#operations/listDeviceEventsDefinitions)")
...
@_mcp_tool(
    name="mist_search_org_wan_clients",
    description="GET /api/v1/orgs/{org_id}/wan_clients/search\n\nsearchOrgWanClients\n\nSearch Org WAN Clients",
    capability=Capability.READ,
)
async def mist_search_org_wan_clients(
    ctx: Context,
    org_id: Annotated[str, Field(description="path parameter 'org_id'")],
