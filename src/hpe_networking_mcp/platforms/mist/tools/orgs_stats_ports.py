...
async def mist_search_org_sw_or_gw_ports(
    ...
    device_type: Annotated[
        str | None,
        Field(description="Type of device. enum: `switch`, `gateway`, `all`. Accepts multiple comma-separated values."),
    ] = None,
    auth_state: Annotated[
        Any | None,
        Field(
    ...
    neighbor_mac: Annotated[
        str | None,
        Field(description="Chassis identifier of the chassis type listed. Accepts multiple comma-separated values."),
    ] = None,
    neighbor_port_desc: Annotated[
        str | None,
        Field(
    ...
    port_id: Annotated[
        str | None, Field(description="Filter results by port identifier. Accepts multiple comma-separated values.")
    ] = None,
    port_mac: Annotated[
        str | None, Field(description="Filter results by port MAC address. Accepts multiple comma-separated values.")
    ] = None,
    speed: Annotated[int | None, Field(description="Filter results by port speed")] = None,
    stp_state: Annotated[
        Any | None,
