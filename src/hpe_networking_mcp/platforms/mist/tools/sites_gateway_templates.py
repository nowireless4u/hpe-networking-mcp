...
@_mcp_tool(
    name="mist_list_site_gateway_templates_derived",
    description="GET /api/v1/sites/{site_id}/gatewaytemplates/derived\n\nlistSiteGatewayTemplatesDerived\n\nGet the list of derived Gateway Templates a Site",
    capability=Capability.READ,
)
async def mist_list_site_gateway_templates_derived(
    ctx: Context,
