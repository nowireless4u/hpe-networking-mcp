...
@_mcp_tool(
    name="mist_list_site_device_profiles_derived",
    description="GET /api/v1/sites/{site_id}/deviceprofiles/derived\n\nlistSiteDeviceProfilesDerived\n\nGet the list of derived Device Profiles for a Site",
    tags={"mist"},
    annotations=ToolAnnotations(readOnlyHint=True, destructiveHint=False),
)
async def mist_list_site_device_profiles_derived(
    ctx: Context,
