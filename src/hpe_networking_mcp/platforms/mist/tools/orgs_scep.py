...
async def mist_list_org_issued_client_certificates(
    ctx: Context,
    org_id: Annotated[str, Field(description="path parameter 'org_id'")],
    sso_name_id: Annotated[str | None, Field(description="sso_name_id obtained from NAC Portal")] = None,
    serial_number: Annotated[str | None, Field(description="Serial Number of the certificate")] = None,
    device_id: Annotated[str | None, Field(description="Device ID")] = None,
) -> Any:
    return await mist_request(
        ctx,
        "GET",
