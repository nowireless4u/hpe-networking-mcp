...
@_mcp_tool(
    name="mist_list_site_network_templates_derived",
    description="GET /api/v1/sites/{site_id}/networktemplates/derived\n\nlistSiteNetworkTemplatesDerived\n\nGet the list of derived Network Templates a Site",
    tags={"mist"},
    annotations=ToolAnnotations(readOnlyHint=True, destructiveHint=False),
)
async def mist_list_site_network_templates_derived(
    ctx: Context,
