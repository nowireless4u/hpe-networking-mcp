...
| *"visualize the X policy"*, *"show me how service Y decides"*, *"walk the policy flow for Z"*, *"render the enforcement chain"*, *"draw the policy"*, *"diagram service N"*, *"why does this MAC get this role"*, *"what does the AirGroup service look like end-to-end"* — ClearPass policy visualization | `clearpass-policy-walker` |
