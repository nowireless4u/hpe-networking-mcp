...
| *"dashboard for site &lt;name&gt;"*, *"show me a dashboard for &lt;site&gt;"*, *"render a status board / scorecard for &lt;site&gt;"*, *"site overview for &lt;site&gt;"*, *"visualize site health for &lt;site&gt;"*, *"draw a dashboard of &lt;site&gt;'s devices and alerts"* (single Aruba Central site — health, devices by type, clients, alerts via Generative UI) | `central-site-dashboard` |
