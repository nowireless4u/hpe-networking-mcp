...
This script reads `vendor/mist_openapi.json` (the upstream Juniper Mist
...
def main(argv: list[str] | None = None) -> int:
    ...
    spec_path = args.spec or (root / "vendor" / "mist_openapi.json")
    ...
    artifact = {
        "_comment": (
            "Generated by scripts/distill_mist_schemas.py from vendor/mist_openapi.json. "
