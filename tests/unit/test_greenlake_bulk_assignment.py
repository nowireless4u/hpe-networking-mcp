...
class TestSubscriptionPatchLimiter:
    def test_is_separate_instance_from_device_add_limiter(self) -> None:
        """_subscription_patch_limiter must be a distinct object from _device_add_limiter."""
    ...
    def test_max_rate_is_20(self) -> None:
        ...
        assert _subscription_patch_limiter.max_rate == 20

    def test_time_period_is_60(self) -> None:
        """Time period must be 60 seconds (per minute)."""
        assert _subscription_patch_limiter.time_period == 60
